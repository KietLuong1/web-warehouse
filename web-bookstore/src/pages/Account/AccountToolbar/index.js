...
export const AccountToolbar = ({ table, onRefresh }) => {
    ...
    return (_jsxs(Stack, { direction: 'column', mt: 1, children: [_jsx(Stack, { direction: 'row', mb: 1, justifyContent: 'space-between', children: _jsxs(Stack, { direction: 'row', spacing: 2, alignItems: 'center', children: [_jsx(Tooltip, { placement: 'top', arrow: true, title: 'Refresh', children: _jsx(IconButton, { sx: {
                                ...
                                }, onClick: onRefresh, children: _jsx(Refresh, {}) }) }), _jsx(Tooltip, { title: 'Filter', arrow: true, placement: 'top', children: _jsx(CustomTableFilterContainer, { filterParamsKeys: undefined, children: _jsx(AccountFilter, {}) }) }), _jsx(CustomTableColumnOptions, { children: _jsx(Tooltip, { title: 'Column Options', arrow: true, placement: 'top', children: _jsx(CustomTableColumnOptionsModal, { table: table }) }) }), _jsx(Button, { type: 'primary', size: 'large', icon: _jsx(PlusOutlined, {}), onClick: openCreate, children: "Create" })] }) }), _jsx(Modal, { title: 'Create Account', open: isModalVisible, onCancel: closeCreate, footer: null, centered: true, styles: { body: { maxHeight: '60vh', overflowY: 'auto', padding: '8px', backgroundColor: 'transparent' } }, children: _jsx(CreateUpdateAccountModal, { onCloseModal: closeCreate }) })] }));
};
